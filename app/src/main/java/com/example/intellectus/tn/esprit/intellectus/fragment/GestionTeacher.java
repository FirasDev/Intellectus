...
import com.example.intellectus.tn.esprit.intellectus.MyTeacher;

/**
 * A simple {@link Fragment} subclass.
 */
public class GestionTeacher extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_gestion_teacher, container, false);
        showFragment2(new MyTeacher());
