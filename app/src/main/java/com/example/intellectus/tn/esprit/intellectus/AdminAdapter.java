...
public class AdminAdapter extends RecyclerView.Adapter<AdminAdapter.ViewHolder> {
    ...
    public AdminAdapter(Context mContext, List<User> elevesList) {
    ...
    public AdminAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new AdminAdapter.ViewHolder(mItemView);
    }
    ...
    private void deleteClass(int id){
        Call<Void> call = myAPI.deleteadmin(id);
    ...
    private void refreshList(){
        ...
        call.enqueue(new Callback<List<User>>() {
            ...
            public void onResponse(Call<List<User>> call, Response<List<User>> response) {
                ...
                AdminAdapter.this.notifyChange(elevesList);
            }
