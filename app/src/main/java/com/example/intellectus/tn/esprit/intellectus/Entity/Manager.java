...
public class Manager {
    ...
    public Manager(int id, String name, String last_name, String email, String role, String is_parent, String image_url, Date dataNaissance, String schoolname) {
        this.id = id;
        this.name = name;
    ...
    public Manager(int id, String name, String last_name, String email, String role, String is_parent, String image_url, Date dataNaissance) {
        this.id = id;
        this.name = name;
        this.last_name = last_name;
        this.email = email;
