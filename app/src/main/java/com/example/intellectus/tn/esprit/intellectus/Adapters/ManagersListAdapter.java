...
public class ManagersListAdapter  extends RecyclerView.Adapter<ManagersListAdapter.ViewHolder>  {
    ...
    public ManagersListAdapter(Context mContext, List<Manager> users) {
    ...
    public void notifyChange(List<Manager> users){
        this.users = users;
    ...
    @NonNull
    @Override
    public ManagersListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {

        View mItemView = LayoutInflater.from(mContext).inflate(R.layout.user_row, parent, false);

        return new ManagersListAdapter.ViewHolder(mItemView);
    }

    @Override
    public void onBindViewHolder(@NonNull ManagersListAdapter.ViewHolder holder, final int position) {
        final Manager singleItem = users.get(position);
        ...
        holder.txtDate.setText(singleItem.getSchoolname());
