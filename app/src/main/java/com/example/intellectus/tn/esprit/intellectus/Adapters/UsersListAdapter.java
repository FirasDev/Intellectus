...
public class UsersListAdapter  extends RecyclerView.Adapter<UsersListAdapter.ViewHolder>  {
    ...
    public UsersListAdapter(Context mContext, List<Student> users) {
    ...
    public void notifyChange(List<Student> users){
        this.users = users;
    ...
    public UsersListAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new UsersListAdapter.ViewHolder(mItemView);
    }

    @Override
    public void onBindViewHolder(@NonNull UsersListAdapter.ViewHolder holder, final int position) {
        final Student singleItem = users.get(position);
        ...
        holder.txtDate.setText(date.substring(7));
        holder.txtQuestion.setText(singleItem.getClassname());
