...
public class TeacherAdapter extends RecyclerView.Adapter<TeacherAdapter.ViewHolder> {
    ...
    public TeacherAdapter(Context mContext, List<User> elevesList) {
    ...
    public TeacherAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        return new TeacherAdapter.ViewHolder(mItemView);
    }
    ...
    private void deleteClass(int id){
        Call<Void> call = myAPI.deleteProf(id);
    ...
    private void refreshList(){
        ...
        Call<List<User>> call = myAPI.getListprof();
        ...
        call.enqueue(new Callback<List<User>>() {
            ...
            public void onResponse(Call<List<User>> call, Response<List<User>> response) {
                ...
                TeacherAdapter.this.notifyChange(elevesList);
            }
